...
public class GunProperty extends Property {
    ...
    public GunProperty(Component owner, int cooldownTime, Component root, Mesh bulletMesh, Texture2DArray explosionSpritesheet, Texture2D bulletTexture, AudioManager audioManager) {
        super(owner, GUN_PROPERTY_NAME);
