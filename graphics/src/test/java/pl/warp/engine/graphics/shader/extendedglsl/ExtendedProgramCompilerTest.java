...
import pl.warp.engine.graphics.shader.ShaderCompilationException;
 ...
 */
public class ExtendedProgramCompilerTest {
    @Test
    public void shouldProcessConstants() throws Exception {
        ConstantField constantField = new ConstantField()
                .set("foo", 2)
                .set("bar", 3);
        ExtendedProgramCompiler compiler = new ExtendedProgramCompiler(null, null, constantField);
    ...
    public void shouldRecognizeOutput() throws Exception {
        ExtendedProgramCompiler compiler = new ExtendedProgramCompiler(null, null, null);
