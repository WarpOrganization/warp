...
public class ExtendedProgram {
    ...
    public ExtendedProgram(int fragmentShader, int vertexShader, int program) {
        this.fragmentShader = fragmentShader;
        this.vertexShader = vertexShader;
        this.program = program;
    }

    public ExtendedProgram(int fragmentShader, int vertexShader, int geometryShader, int program) {
        this.fragmentShader = fragmentShader;
        this.vertexShader = vertexShader;
