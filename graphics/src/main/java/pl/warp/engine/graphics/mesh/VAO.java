...
public class VAO {
    ...
    public VAO(int[] buffers, int indexbuffer, int[] attributes, int[] sizes, int[] types) {
        this.vao = GL30.glGenVertexArrays();
        this.buffers = buffers;
        this.indexbuffer = indexbuffer;
        createVAO(buffers, indexbuffer, attributes, sizes, types);
    }

    private void createVAO(int[] buffers, int indexbuffer, int[] attributes, int[] sizes, int[] types) {
