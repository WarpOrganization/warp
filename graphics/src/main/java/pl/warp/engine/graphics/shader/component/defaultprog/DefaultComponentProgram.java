...
public class DefaultComponentProgram extends ComponentRendererProgram {
    ...
    private static final int MAIN_TEXTURE_SAMPLER = 0;
    ...
    private static final String[] SPOT_LIGHT_FIELD_NAMES =
            {"position", "color", "ambientColor", "attenuation", "gradient", "specularFactor"};
    private static final String[] DIRECTIONAL_LIGT_FIELD_NAMES =
            {"position", "direction", "directionGradient", "color", "ambientColor", "attenuation", "gradient", "specularFactor"};
    ...
    private void setupSamplers() {
        setUniformi(unifMainTexture, MAIN_TEXTURE_SAMPLER);
    }

    @Override
    public void useMaterial(Material material) {
        useTexture(material.getMainTexture(), MAIN_TEXTURE_SAMPLER);
        setUniformf(unifBrightness, material.getBrightness());
    }
    ...
    private void setSpotLight(int[] lightStruct, SpotLight light) {
        ...
        setUniformf(lightStruct[SPOT_LIGHT_SPECULAR_FACTOR], light.getSpecularFactor());
    }
    ...
    private void setDirectionalLight(int[] lightStruct, DirectionalSpotLight light) {
        ...
        setUniformf(lightStruct[DIRECTIONAL_LIGHT_SPECULAR_FACTOR], light.getSpecularFactor());
    }
}
