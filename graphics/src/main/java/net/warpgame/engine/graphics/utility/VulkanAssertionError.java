 ...
 * Created 11.04.2019
 */
public class VulkanAssertionError extends AssertionError {
    public VulkanAssertionError(String msg, int result){
        super(String.format("%s: %s", msg, translateVulkanResult(result)));
    }
