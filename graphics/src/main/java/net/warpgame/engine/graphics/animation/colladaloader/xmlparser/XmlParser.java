package net.warpgame.engine.graphics.animation.colladaloader.xmlparser;
...
public class XmlParser {
	 ...
	 */
	public static XmlNode loadXmlFile(InputStream collada) {
		BufferedReader reader = null;
		try {
			reader = new BufferedReader(new InputStreamReader(collada));
		} catch (Exception e) {
