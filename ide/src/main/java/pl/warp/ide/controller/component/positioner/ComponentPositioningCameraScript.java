 ...
 */
public class ComponentPositioningCameraScript extends GameScriptWithInput<GameComponent> {
    ...
    public ComponentPositioningCameraScript(GameComponent cameraComponent, Camera camera, GameComponent rotatingComponent) {
