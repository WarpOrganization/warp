 ...
 */
@Service
public class EventMessageProcesor implements MessageProcessor {

    private EventDeserializer eventDeserializer;
    private ComponentRegistry componentRegistry;

    public EventMessageProcesor(ComponentRegistry componentRegistry) {
    ...
    public void processMessage(Peer sourcePeer, ByteBuf messageContent) {
        ...
        NetworkEvent networkEvent = (NetworkEvent) eventDeserializer.deserialize(messageContent);
