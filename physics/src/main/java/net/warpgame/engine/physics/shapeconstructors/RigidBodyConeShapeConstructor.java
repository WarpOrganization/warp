 ...
 * Created 09.06.2018
 */
public class RigidBodyConeShapeConstructor extends RigidBodyShapeConstructor{
     ...
     */
    public RigidBodyConeShapeConstructor(float radius, float height) {
        this.radius = radius;
        this.height = height;
    }
    ...
    public void construct() {
        constructedShape = new btConeShape(radius, height);
    }
