...
public class PositionsTest {
    ...
    public void getPositionRelativeToParent() throws Exception {
        ...
        c2.addProperty(new PositionProperty(position, new LazyPositionCalculationStrategy(), 4));
    ...
    public void getPositionRelativeToNeighbour() throws Exception {
        ...
        c2.addProperty(new PositionProperty(position2, new LazyPositionCalculationStrategy(), 3));
        Component c3 = new SimpleComponent(c1);
        Vector3f position3 = new Vector3f(14.0f);
        c3.addProperty(new PositionProperty(position3, new LazyPositionCalculationStrategy(), 3));
        Vector3f dest = new Vector3f();
    ...
    public void getPositionRelativeToNeighbour2() throws Exception {
        ...
        c4.addProperty(new PositionProperty(position4, new LazyPositionCalculationStrategy(), 3));
        Vector3f dest = new Vector3f();
    ...
    public void getMutualUnit() throws Exception {
        ...
        c2.addProperty(new PositionProperty(new Vector3f(), new ImmediatePositionCalculationStrategy(), 2));
        c3.addProperty(new PositionProperty(new Vector3f(), new ImmediatePositionCalculationStrategy(), 2));
    ...
    public void getPositionProperty() throws Exception {
        EngineContext context = mock(EngineContext.class);
        Component c1 = new SimpleComponent(context);
        PositionProperty prop = new PositionProperty(new Vector3f(), new ImmediatePositionCalculationStrategy(), 2);
        c1.addProperty(prop);
    ...
    public void hasPosition() throws Exception {
        ...
        Component c1 = new SimpleComponent(context);
        c1.addProperty(new PositionProperty(new Vector3f(), new ImmediatePositionCalculationStrategy(), 2));
